...
└── skills/create-loop/               THE INSTALLABLE SKILL (copied verbatim by installer)
    ...
    ├── references/                   20 docs — locked vocabulary + policy
...
- Full per-doc map of the 20 `references/` files is not yet built — only the 4 locked-vocabulary docs were read at init. [TODO]
